...
def write_json_file(filename: str, content: dict) -> None:
    ...
    The function takes two arguments:
        ...
        - content (dict): The dictionary containing all information to be written into the json file.
...
def export_ytplaylist_file(filename: str, ytplaylist_dict: dict) -> None:
    """
    The export_ytplaylist_file function writes the playlist title and playlist items from a given dict to a file.
    The filename is the name of the ytplaylist file, while ytplaylist_dict is a dictionary containing two keys:
    'Playlist Title' and 'Playlist Items'. The function will write these values to an output file with extension .ytplaylist.
